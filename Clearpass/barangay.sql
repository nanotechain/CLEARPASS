...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2025 at 09:08 PM
...
(1267, 'ADMIN: Admin Admin | LOGIN', '15-10-2025 12:30 AM', 'login'),
(1268, 'RESIDENT: REGISTER RESIDENT - 41521701360353 |  Nathaniel Gonzales NA', '15-10-2025 12:40 AM', 'create'),
(1269, 'RESIDENT: Nathaniel Gonzales | LOGIN', '15-10-2025 12:41 AM', 'login'),
(1270, 'RESIDENT - 41521701360353: Nathaniel Gonzales | REQUEST CERTIFICATE - INDIGENCY', '15-10-2025 12:44 AM', 'create'),
(1271, 'ADMIN: RESIDENT REQUEST CERTIFICATE ACCEPTED - 41521701360353 | PURPOSE INDIGENCY | MESSAGE none | DATE ISSUED 2025-10-15 | DATE EXPIRED 2025-10-15', '14-10-2025 6:45 PM', 'updated'),
(1272, 'ADMIN: ADDED OFFICIAL - 1015202500584551537 | CHAIRMAN Rowell Torres  | START 2022-05-15 END 2028-05-07', '15-10-2025 12:58 AM', 'create'),
(1273, 'ADMIN: UPDATED ADMINISTRATOR FIRST NAME  -  174668789044820710152022021619941 |  FROM Secretary TO Christine', '14-10-2025 7:15 PM', 'update'),
(1274, 'ADMIN: UPDATED ADMINISTRATOR MIDDLE NAME  -  174668789044820710152022021619941 |  FROM Secretary TO Lazaro', '14-10-2025 7:15 PM', 'update'),
(1275, 'ADMIN: UPDATED ADMINISTRATOR LAST NAME  -  174668789044820710152022021619941 |  FROM Secretary TO Lanaja', '14-10-2025 7:15 PM', 'update'),
(1276, 'RESIDENT - 41521701360353: Nathaniel Gonzales | REQUEST CERTIFICATE - SCHOOLARSHIP', '15-10-2025 2:18 AM', 'create'),
(1277, 'ADMIN: RESIDENT REQUEST CERTIFICATE ACCEPTED - 41521701360353 | PURPOSE SCHOOLARSHIP | MESSAGE none | DATE ISSUED 2025-10-15 | DATE EXPIRED 2025-10-15', '14-10-2025 8:19 PM', 'updated'),
(1278, 'ADMIN: Admin Admin | LOGOUT', '14-10-2025 8:33 PM', 'logout'),
(1279, 'ADMIN: Admin Admin | LOGIN', '15-10-2025 2:34 AM', 'login'),
(1280, 'ADMIN: Admin Admin | LOGOUT', '14-10-2025 8:37 PM', 'logout'),
(1281, 'ADMIN: Admin Admin | LOGIN', '15-10-2025 2:38 AM', 'login'),
(1282, 'RESIDENT: Nathaniel Gonzales | LOGIN', '15-10-2025 2:39 AM', 'login'),
(1283, 'RESIDENT - 41521701360353: Nathaniel Gonzales | REQUEST CERTIFICATE - SCHOOLARSHIP', '15-10-2025 2:52 AM', 'create'),
(1284, 'ADMIN: RESIDENT REQUEST CERTIFICATE ACCEPTED - 41521701360353 | PURPOSE SCHOOLARSHIP | MESSAGE none | DATE ISSUED 2025-10-15 | DATE EXPIRED 2025-10-15', '14-10-2025 8:53 PM', 'updated'),
(1285, 'ADMIN: Admin Admin | LOGOUT', '14-10-2025 8:54 PM', 'logout'),
(1286, 'OFFICIAL: Christine Lanaja | LOGIN', '15-10-2025 2:54 AM', 'login'),
(1287, 'OFFICIAL: Christine Lanaja | LOGOUT', '14-10-2025 9:06 PM', 'logout');
...
(169, 'BackupFile-04012025_070554.sql'),
(172, 'BackupFile-10142025_184747.sql');
...
('32432432432432432', 'BATIA', 'BOCAUE', 'District V', 'BULACAN', '3018', '196102789068ee32b31216a.png', '../assets/dist/img/196102789068ee32b31216a.png');
...
(64, '137400776110152025004448519105564655368ee7e007ec0d', '41521701360353', 'none', 'INDIGENCY', 'none', '2025-10-15', '10/15/2025', '2025-10-15', 'ACCEPTED'),
(65, '168639396110152025021850430138456042268ee940a69683', '41521701360353', 'none', 'SCHOOLARSHIP', 'none', '2025-10-15', '10/15/2025', '2025-10-15', 'ACCEPTED'),
(66, '21708290910152025025240895205209510568ee9bf8da99b', '41521701360353', 'none', 'SCHOOLARSHIP', 'none', '2025-10-15', '10/15/2025', '2025-10-15', 'ACCEPTED');
...
(65, '1015202500584551537', 'Rowell', 'Cruz', 'Torres', '', '1988-02-02', 'wakas', 'Male', '37', 'Single', '', '', 'Bocaue', '3018', 'Batia', 'blk 3 lot 4', 'bakabakahan road', 'Norville V', 'rowell.torres@dyci.edu.ph', '09511253837', '', '', '', '', '114301385068ee81457d789.png', '../assets/dist/img/114301385068ee81457d789.png');
...
(59, '1015202500584551537', '619131249471207208162022141229307', '', 'NO', '2022-05-15', '2028-05-07', 'NO', '', 'ACTIVE', 'YES', 'NO', '10/15/2025 12:58 AM', 'none');
...
(182, '41521701360353', 'Nathaniel', 'DeLa Cruz', 'Gonzales', '25', 'NA', '', 'Male', 'Single', 'UPC', 'Filipino', '09511253832', 'nathaniel.gonzales@dyci.edu.ph', 'Northville', '2000-02-01', 'Batia', 'Bocaue', '3018', 'Batia', '', 'bakabakahan road', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '142195623968ee7cea52f85.png', '../assets/dist/img/142195623968ee7cea52f85.png');
...
(182, '41521701360353', 'ACTIVE', '', 'YES', 'NO', '', 'NO', 'NO', '', '', '', '', 'NO', '10/15/2025 12:40 AM', 'none', 'none');
...
(52, '1506135735699', 'Admin', 'Admin', 'Admin', 'admin123', 'admin123', 'admin', '11111111111', '203205386268ee976622a31.png', '../assets/dist/img/203205386268ee976622a31.png'),
(195, '174668789044820710152022021619941', 'Christine', 'Lazaro', 'Lanaja', 'secretary123', 'secretary123', 'secretary', '99999999999', '116010046168ee84978c58f.jpg', '../assets/dist/img/116010046168ee84978c58f.jpg'),
(205, '41521701360353', 'Nathaniel', 'DeLa Cruz', 'Gonzales', 'naths020102', 'naths123', 'resident', '09511253832', '142195623968ee7cea52f85.png', '../assets/dist/img/142195623968ee7cea52f85.png');
...
--
ALTER TABLE `official_status`
  MODIFY `a_i` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `residence_information`
  MODIFY `a_i` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;
...
--
ALTER TABLE `users`
  MODIFY `a_i` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
